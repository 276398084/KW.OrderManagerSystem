...
namespace CodeGenerator.Business
{
    ...
    public partial class CodeGenerator
    {
        ...
        private void GetCodeClassName()
        {
            ...
            {
                case "TypeMap":
                    this.CodeText.AppendLine("    public class " + this.className + "TypeMap : ClassMap<" + this.className + "Type> ");
                    break;
                case "Domian":
                    this.CodeText.AppendLine("    public class " + this.className + "Type");
                    break;
                case "Manager":
