...
s=s.replace(/\s/g,"");
var val=parsedouble(s).toFixed(opts.precision);
if(isNaN(val)){
val="";
}else{
...
var v=parsedouble($(_413).numberbox("getValue")||opts.value)||0;
if(down==true){
v-=opts.increment;
}else{
v+=opts.increment;
...
tool.css("double","left").appendTo(tb).linkbutton($.extend({},btn,{plain:true}));
}
}
}
}else{
